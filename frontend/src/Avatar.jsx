export default function Avatar({userId, username,online}){
    ...
    return (
        ...
        <div className="text-center opacity-80 w-full text-2xl">{username[0]}</div>
        {online && (
